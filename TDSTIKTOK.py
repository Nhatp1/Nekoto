...
\033[32;5;245m\033[1m\033[38;5;39m╚═╝  ╚═══╝╚═╝           ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
\033[1;36m╠═══════════════════════════════════════════════╣
\033[1;36m║\033[38;5;204m▶Nhóm   : \033[38;5;20mhttps://zalo.me/g/vmugmo123        \033[1;36m║
...
def delay(dl):
  try:
    for i in range(dl, -1, -1):
       print(f'{vang}[{trang}NP-TOOL{vang}][{trang}'+str(i)+vang+']           ',end='\r')
       sleep(1)
  except:
     sleep(dl)
     print(dl,end='\r')
...
def main():
	...
	while True:
		if os.path.exists('configtds.txt'):
			...
			data = tds.main()
			try:
				print(f'{n_tool}{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản '+vang+ data['user'] )
				print(f'{n_tool}{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TDS Mới')
				chon = input(f'{n_tool}{luc}Nhập {trang}===>: {vang}')
				if chon == '2':
...
#while True:
	...
	banner()
	print(f'{n_tool}{luc}Tên Tài Khoản: {vang}{user} ')
	print(f'{n_tool}{luc}Xu Hiện Tại: {vang}{xu}')
	print(f'{n_tool}{luc}Xu Bị Phạt: {vang}{xudie} ')
	while True:
		ntool=0
		bongoc(14)
		print(f'{n_tool}{luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Tim')
		print(f'{n_tool}{luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Follow')
		print(f'{n_tool}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now')
		nhiem_vu=input(f'{p_tool}{luc}Nhập Số Để Chạy Nhiệm Vụ: {vang}')
		dl = int(input(f'{n_tool}{luc}Nhập Delay: {vang}'))
		while True:
			if ntool == 2:
				break
			ntool = 0
								...
								if cache != True:
									...
									if dem % nv_nhan == 0:
										...
										if nhan == 0:
											...
											chon=input(f'{NP-TOOL}{luc}Nhập {trang}===>: {vang}')
											if chon == '1':
												ntool=2
												break
											elif chon =='2':
									...
									if dem % nv_nhan == 0:
										...
										if nhan == 0:
											...
											if chon == '1':
												...
												break
											bongoc(14)
main()\033[1;97m[\033[1;91m❣\033[1;97m]\033[1;97m Tik Tok\033[1;31m  : \033[1;33mhttps:\033[1;32m//www.tiktok.com\033[1;31m/m@nekosharetool
...
#while True:
	...
	while True:
		...
		print(f'{huong_pc}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now')
		nhiem_vu=input(f'{huong_pc}{luc}Nhập Số Để Chạy Nhiệm Vụ: {vang}')
